...
# Trippy v10.2.1: Immich-style web UI route-tour generator for Proxmox LXC
# Adds stop-based clustering, stop radius, stop review/editing, and lasso grouping.
#
# Run on Proxmox host:
#   bash trippy-install-v10.2.1.sh
#
# Optional:
#   CTID=106 STORAGE=local-lvm BRIDGE=vmbr0 bash trippy-install-v10.2.1.sh
...
printf "${CYAN}${BOLD}Trippy v10.2.1 Clean Installer${RESET}\n"
...
pct set "$CTID" --description "🧭 Trippy v10.2.1
...
app = FastAPI(title="Trippy", version="1.2.1")
...
// Trippy v10.2.1 UI behavior upgrades
(function(){{
  function ready(fn){{ if(document.readyState!=='loading') fn(); else document.addEventListener('DOMContentLoaded',fn); }}
  window.TRIPPY_VERSION='v10.2.1';
  ready(() => {{
    if(!document.querySelector('.versionBadge')){{
      const v=document.createElement('div'); v.className='versionBadge'; v.textContent='v10.2.1'; document.body.appendChild(v);
    }}
...
# v10.2.1: patch the ACTUAL served frontend file, not backend/main.py.
...
# v10.2.1: real frontend redesign patch against the served index.html.
...
# v10.2.1: full frontend replacement, not an overlay.
pct exec "$CTID" -- bash -lc "cat >/tmp/trippy_frontend.b64 <<'EOF_TRIPPY_FRONTEND_B64'

...
pct exec "$CTID" -- bash -lc "grep -q 'Trippy v10.2.1' /opt/trippy/frontend/index.html && grep -q 'Present Journey' /opt/trippy/frontend/index.html && grep -q 'trippyLogo' /opt/trippy/frontend/index.html" >/dev/null 2>&1 || {
...
echo
printf "${CYAN}${BOLD}v10.2.1 features${RESET}\n"
...
printf "  ${CYAN}•${RESET} Safer project thumbnail proxy for new projects\n"printf "  ${CYAN}•${RESET} v10.2.1 directly patches /opt/trippy/frontend/index.html
"
...
printf "  ${CYAN}•${RESET} v10.2.1 real UI pass: cleaner top bar, Present Mode, export tucked away, better popups, stop title suggestions\n"
printf "  ${CYAN}•${RESET} v10.2.1 full frontend replacement inspired by the mockup UI\n"
